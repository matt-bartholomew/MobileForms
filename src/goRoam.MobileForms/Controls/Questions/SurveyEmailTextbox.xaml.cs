...
{
    public partial class EmailTextbox : Xamarin.Forms.Grid
    {
        bool _initing;

        public static readonly BindableProperty TitleProperty = BindableProperty.Create(nameof(Title), typeof(string), typeof(EmailTextbox), default(string), Xamarin.Forms.BindingMode.OneTime);
        public string Title
        {
        ...
        public static readonly BindableProperty HelperTextProperty = BindableProperty.Create(nameof(HelperText), typeof(string), typeof(EmailTextbox), default(string), Xamarin.Forms.BindingMode.OneTime);
        ...
        public static readonly BindableProperty TextProperty = BindableProperty.Create(nameof(Text), typeof(string), typeof(EmailTextbox), default(string), BindingMode.TwoWay);
        public string Text
        {
        ...
        public static readonly BindableProperty IsRequiredProperty = BindableProperty.Create(nameof(IsRequired), typeof(bool), typeof(EmailTextbox), default(string), BindingMode.OneTime);
        ...
        public static readonly BindableProperty IsValidProperty = BindableProperty.Create(nameof(IsValid), typeof(bool), typeof(EmailTextbox), true, BindingMode.OneWayToSource);
        public bool IsValid
        {
        ...
        public static readonly BindableProperty IsReadOnlyProperty = BindableProperty.Create(nameof(IsReadOnly), typeof(bool), typeof(EmailTextbox), false, BindingMode.OneTime);
