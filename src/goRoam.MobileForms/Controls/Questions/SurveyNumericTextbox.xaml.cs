...
{
    public partial class NumericTextbox : Xamarin.Forms.Grid
    {
        bool _initing;

        public static readonly BindableProperty TitleProperty = BindableProperty.Create(nameof(Title), typeof(string), typeof(NumericTextbox), default(string), Xamarin.Forms.BindingMode.OneTime);
        public string Title
        {
        ...
        public static readonly BindableProperty HelperTextProperty = BindableProperty.Create(nameof(HelperText), typeof(string), typeof(NumericTextbox), default(string), Xamarin.Forms.BindingMode.OneTime);
